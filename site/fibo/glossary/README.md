...
This is the frontend app for the FIBO glossary. This app is based on the React framework
which incubated at Facebook. They have an app called the "Create React App" that can
generate and sort of maintain the boilerplate code for a typical React-based app. Which
is what we used.

Below you see text that is generated by this Create React App:
