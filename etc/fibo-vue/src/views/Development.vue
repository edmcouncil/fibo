    ...
    <main>
      <article>
        ...
        <h2>
          ...
          <a
            href="products.html"
          >a variety of products</a> in file formats and dialects ranging from HTML to JSON-LD.
          All are generated, or derived from, the
          <a
            href="fibo_owl.html"
          >FIBO OWL</a> system of record using the
        ...
        <p>
          ...
          >GitHub based git-repository</a> (accessible for members only) that
        ...
        <p>
          ...
          >JIRA</a>. For each discussed and approved JIRA-based
