      ...
      <article>
        ...
        <ul>
          ...
          <li>
            <b>2018 Q1</b>
            <ul>
              <li>Added simpler provenance links, hasDomain and hasSubDomain</li>
            </ul>
          </li>
          ...
          <li>
            <b>2017 Q4</b>
            <ul>
              <li>Change namespace conventions to simplify the IRIs of concepts</li>
              <li>Indicate for each concept its source domain, using dct:isPartOf</li>
            </ul>
          </li>
