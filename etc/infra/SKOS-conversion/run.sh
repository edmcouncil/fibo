...
java -Xmx1024M -Dlog4j.configuration="file:$JENAROOT/jena-log4j.properties" -cp "$FIBO_INFRA/lib;$FIBO_INFRA/lib/SPIN/spin-1.3.3.jar" org.topbraid.spin.tools.RunInferences http://example.org/example temp.ttl > temp1.ttl
